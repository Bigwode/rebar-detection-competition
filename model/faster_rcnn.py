...
from model.utils.nms.cpu_nms import cpu_soft_nms


def soft_nms(dets, sigma=0.5, Nt=0.5, threshold=0.7, method=2):
...
class FasterRCNN(nn.Module):
    ...
    def predict(self, imgs, sizes=None, visualize=False):
        ...
        for img, size in zip(prepared_imgs, sizes):
            ...
            raw_cls_bbox = at.tonumpy(cls_bbox)  # [300, 8]
            raw_prob = at.tonumpy(prob)  # [300,2]
